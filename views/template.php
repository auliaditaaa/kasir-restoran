...
<head>
	<title>Restoran enak dita</title>
	<meta charset="utf-8">
...
<body>
	...
	<div id="wrapper">
					...
					<ul class="nav">
						<?php
							...
							?>
								...
								<li>
									<a href="<?=base_url('index.php');?>/masakan" <?php if($main_menu == 'masakan'):?>class="active"<?php endif;?>><i class="fa fa-map"></i> <span>Masakan</span></a>
								</li>

								<li>
									<a href="<?=base_url('index.php');?>/pelanggan/list_pelanggan" <?php if($main_menu == 'pelanggan'):?>class="active"<?php endif;?>><i class="fa fa-map"></i> <span>Pelanggan</span></a>
								</li>
								<li>
									<a href="<?=base_url('index.php');?>/transaksi" <?php if($main_menu == 'transaksi'):?>class="active"<?php endif;?>><i class="fa fa-map"></i> <span>Transaksi</span></a>
								</li>

								<?php if ($this->session->userdata('level_name') == 'superadmin'): ?>
									<li>
										<a href="<?=base_url('index.php');?>/admin" <?php if($main_menu == 'admin'):?>class="active"<?php endif;?>><i class="fa fa-map"></i> <span>Admin</span></a>
									</li>
								<?php endif ?>
							<?php
							}elseif ($this->session->userdata('username_pelanggan')) {
							?>
								<li>
									<a href="<?=base_url('index.php');?>/pelanggan" class="active">
										<i class="fa fa-map"></i> <span>Pemesanan</span>
									</a>
								</li>
							<?php
							}
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">Shared by <i class="fa fa-love"></i><a href="https://bootstrapthemes.co">Restoran enak dita</a>
</p>
			</div>
		</footer>
	</div>
